...
namespace FlightFinalSite.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlaneID,PlaneName,PlaneType,PlaneCapacity")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlaneID,PlaneName,PlaneType,PlaneCapacity")] Plane plane)
        {
            if (ModelState.IsValid)
            {
